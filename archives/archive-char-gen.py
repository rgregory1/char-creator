...
Sorcery = {
  'power_name': 'Sorcery',
  'power_type': 'major',
  'description': 'Your knowledge of the arcane arts makes you a dangerous and versatile foe. Select one major power (excepting Sorcery) and four minor powers (excepting Magic Artifact and Shield). This list comprises your grimoire.',
  'additional_minorp': minp_list_of,
  'additional_minorp_prefix': 'Grimoire',
  'add_p_num': 4,
  'stat_changes': {},
  'notes': 'Sorcery (Major)- 15in range, body damage  \n'
}
